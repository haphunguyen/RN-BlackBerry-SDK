/*
 *  (c) 2015 BlackBerry Limited. All rights reserved.
 */

#import <UIKit/UIKit.h>
#import <BlackBerryLauncher/GTLCommonSettingsCellConfiguration.h>
 ...
 */
- (UIViewController *)settingsViewControllerForLauncherViewController:(GTLauncherViewController *)controller DEPRECATED_MSG_ATTRIBUTE("This method will be removed in a future release. Implement 'applicationSettingsTableViewControllerForLauncher:' instead.");
...
/**
 ...
 be presented instead.
 - parameters:
    - controller: ``GTLauncherViewController`` that is requesting style for particular cell.
 - returns: ``UITableViewController`` with the settings for the host application. Returning ``nil`` will cause the default behavior of having the Launcher Common settings view controller being displayed.
 */
- (UITableViewController * _Nullable)applicationSettingsTableViewControllerForLauncher:(GTLauncherViewController *)controller;

/**
 To customize Launcher Common settings options styles, use this configuration API.
 
 Host application can configure styles for Common settings section by returning ``GTLCommonSettingsCellConfiguration`` object.
 If this method is not implemented, default style will be used.
 
- seealso: ``GTLCommonSettingsCellConfiguration``
- seealso: ``GTLCommonSettingsCellType``
- parameters:
   - cellType: ``GTLCommonSettingsCellType`` type of table view cell that requests styling.
   - controller: ``GTLauncherViewController`` that is requesting style for particular table view cell.
 
 - returns: ``GTLCommonSettingsCellConfiguration`` with the settings for the host application. Returning nil will cause the default behavior and default style to be applied.
 */
...
/**
 Method to pressent Settings.
 
 Can be used to pressent Settings screen via other than Settings button in Launcher actions.
 */
